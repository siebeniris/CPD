...
def preprocess_reviews_train():
    with open("../../Unsupervised-Aspect-Extraction/preprocessed_data/app_reviews/appstore.json", "rt") as f:
        reviews = json.load(f)
    with open("../../Unsupervised-Aspect-Extraction/preprocessed_data/app_reviews/train.txt", "wt") as f:
