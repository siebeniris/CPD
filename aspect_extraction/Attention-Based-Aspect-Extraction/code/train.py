...
def sentence_batch_generator(data, batch_size):
    """
    Generate the sentence batches.
    :param data: A list of lists of indices (word ids)
    :param batch_size: the size of one batch data.
    :return: Generator for the batch sentences.
    """
...
def negative_batch_generator(data, batch_size, neg_size):
    """
    Randomly sample few data samples in one batch to be negative samples
    :param data: data for training or testing
    :param batch_size: the size of one batch data
    :param neg_size: negative factor. number of negative samples for one batch
